    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28 scheme-2">
      <div className="container">
        <div className="mb-8 w-full max-w-lg md:mb-10 lg:mb-12">
          ...
          <h2 className="mb-5 text-h2 font-bold md:mb-6">Apply to volunteer</h2>
        ...
        <form className="grid w-full max-w-md grid-cols-1 gap-6">
          ...
          <div className="grid w-full items-center">
            ...
            <Textarea
              id="message"
              placeholder="Share your background and when you can help."
          ...
          <div className="mb-3 flex items-center space-x-2 text-small md:mb-4">
            ...
            <Label htmlFor="terms" className="cursor-pointer">
              I'm interested in volunteering with CCA.
            </Label>
          </div>
          <div>
            <Button title="Submit application">Submit application</Button>
          </div>
        </form>
      </div>
    </section>
